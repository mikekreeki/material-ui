...
var EnhancedSwitch = _react2.default.createClass({
  ...
  componentWillMount: function componentWillMount() {
    ...
    process.env.NODE_ENV !== "production" ? (0, _warning2.default)(name || label || id, 'We don\'t have enough information to build a\n      robust unique id for the EnhancedSwitch component. Please provide an id or a name.') : undefined;

    var uniqueId = name + '-' + label + '-' + Math.floor(Math.random() * 0xFFFF);
  ...
  render: function render() {
    ...
    var onSwitch = _props2.onSwitch;
    var defaultSwitched = _props2.defaultSwitched;
    ...
    var other = _objectWithoutProperties(_props2, ['name', 'value', 'label', 'onSwitch', 'defaultSwitched', 'onBlur', 'onFocus', 'onMouseUp', 'onMouseDown', 'onMouseLeave', 'onTouchStart', 'onTouchEnd', 'disableTouchRipple', 'disableFocusRipple', 'className']);
    ...
    var inputId = this.props.id || this.uniqueId;
